...
for epoch in 3 9 ; do
    bash /scratch1/runhuixu/LLaVA-Med/scripts/chunyl/finetune_on_benchmarks/fine_tuning_pathvqa_7B.sh $epoch
    bash /scratch1/runhuixu/LLaVA-Med/scripts/chunyl/finetune_on_benchmarks/eval_pathvqa.sh $epoch
