...
torchrun --nnodes=1 --nproc_per_node=1 --master_port=25001 \
    ...
    --tune_mm_mlp_adapter True \
    --bf16 True \
    --output_dir /scratch1/runhuixu/outputs/slake \
...
checkpoint_folder="/scratch1/runhuixu/outputs/slake/epoch_$NUM_EPOCHS"
mkdir -p $checkpoint_folder
find /scratch1/runhuixu/outputs/slake -maxdepth 1 -type f -exec cp {} $checkpoint_folder \;